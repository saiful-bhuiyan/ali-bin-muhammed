...
<body style="background: #32aba9">
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="#">3. Parts Sales Report</a></li>
  ...
  <section class="home-section" style="background: #32aba9;">
    ...
    <div class="container col-lg-10 rounded-3 text-center" style="background: #4a91bd; ">
      <label class="text-center fs-2 mb-3 headline">Parts Sales Report</label>
 ...
 <script>
    ...
    $('#adminRef').click(function(){
      ...
      if(date1 != "" && date2 != ""){
        ...
        var myWindow = window.open('sales_print_report.php?date1='+ date1 +"&date2="+ date2, 'Parts Sales Report',
