...
<body style="background: #32aba9;">
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="#">8. Saqar Cost Entry</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
  ...
  <section class="home-section" style="background: #32aba9;">
    ...
    <div class="container col-lg-10 rounded-3 text-center" style="background: #4a91bd; ">
      <label class="text-center fs-2 mb-3 headline">Saqar Cost Entry</label>
      <div class="row mx-auto text-center mb-3">
        

        <?php
          $date = date("Y-m-d");
          $query ="SELECT MAX(`invoice_no`+1) AS invoice FROM `saqar_cost_entry`";
        ...
        <div class="mb-3 col-lg-5 col-md-6 col-sm-12">
          <label  class="form-label">Cost Details :</label><br>
          <input type="text" class="col-lg-8 col-md-10 col-sm-12 form-control" id="costDetails" placeholder="Text here " maxlength="50" >
        </div>
        ...
        <table id="table" class="table table-striped table-bordered">
          ...
          <tbody>
            <?php
              ...
              $sel="SELECT `invoice_no`,`cost_details`,TRUNCATE(`amount`,3) AS amount,`date` FROM `saqar_cost_entry` WHERE `date`='$date'";
 ...
 <script>
    ...
    $(document).on('click','#AddSaqar',function(){
      ...
      if(txtInvoice !="" && costDetails !="" && txtAmnt !=""){

        if(numAmnt > 0){

        $.ajax({
          url: 'addSaqarCost.php',
          type: "POST",
          data:{
          ...
          success:function(response){
            swal({
                ...
                window.location ="saqar_cost_entry.php";
              });         
          }
        });
