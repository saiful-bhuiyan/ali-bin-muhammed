...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Monthly Profit Cost</title>
...
<body style="background: #32aba9">
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="#">6. Monthly Profit Cost</a></li>
  ...
  <section class="home-section" style="background: #32aba9;">
    ...
    <div class="container col-lg-10 rounded-3 text-center" style="background: #4a91bd; ">
      ...
      <label class="text-center fs-2 mb-3 headline">Monthly Profit Cost</label>
      <div class="row mx-auto text-center mb-3">
        
        <!-- Php code of get ID -->

          <?php
            $query="SELECT MAX(`id`) FROM `monthly_profit_cost`";
        ...
        <div class="mb-3 col-lg-6 col-md-6 col-sm-12" hidden>
         ...
         <?php
          $date = date("Y-m-d");
          $query ="SELECT MAX(`invoice_no`+1) AS invoice FROM `monthly_profit_cost`";
            $q=mysqli_query($con, $query);
            if($q){
        ...
        <div class="mb-3 mx-auto col-lg-6 col-md-6 col-sm-12">
          ...
          <select class="form-select" id="costName">
            ...
            <?php
              $query="SELECT `cost_name` FROM `monthly_cost_setup`";
              $q=mysqli_query($con, $query);
              if($q){
        ...
        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
          ...
          <input type="text" class="col-lg-8 col-md-10 col-sm-12 form-control " id="txtReason" placeholder=" " maxlength="100">
        </div> 
        ...
        <div class="mb-3" id="insertBtn">
          <button class="btn btn-success" id="AddMPC" type="button">Save</button>
        </div>
      </div>
      </div>
    </div>
        ...
        <table id="table" class="table table-striped table-bordered">
          ...
          <tbody>
            <?php
              ...
              $sel="SELECT `id`,`invoice_no`,`cost_name`,`reason`,TRUNCATE(`cost_amount`,3) AS cost_amount,`date`
                     FROM `monthly_profit_cost`
 ...
 <script>
  ...
  // Redirect to login page
    ...
    $(document).on('click','#AddMPC',function(){
      $('#AddMPC').attr("disabled", "disabled");
      $('#AddMPC').text("Please Wait !!!");
      ...
      if(fID !="" && costName !="" && txtReason !="" && costAmount !=""){
          ...
          $.ajax({
            ...
            success:function(response){
              swal({
                  ...
                  window.location ="monthly_profit_cost.php";
                });         
            }
          });
